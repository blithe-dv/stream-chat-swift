...
internal class _ChatMessageThreadArrowView<ExtraData: ExtraDataTypes>: View, UIConfigProvider {
...
internal class _ChatMessageThreadInfoView<ExtraData: ExtraDataTypes>: Control, UIConfigProvider {

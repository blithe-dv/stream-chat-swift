...
internal class ChatMessageListCollectionViewLayout: UICollectionViewLayout {
    ...
    override internal func initialLayoutAttributesForAppearingItem(at itemIndexPath: IndexPath)
    ...
    override internal func finalLayoutAttributesForDisappearingItem(at itemIndexPath: IndexPath)
        -> UICollectionViewLayoutAttributes? {
        let idx = itemIndexPath.item
